...
class register_admin extends Component {
    constructor() {
        super();
        this.state = {
            username: null,
    ...
    register = async () => {
        ...
        try {
            await post(object, "user/register_admin", null).then(result => {
                ...
                <Card style={{
                    ...
                    <Card.Body className="mx-4 mt-4">
                        ...
                        <Form.Row className="d-flex justify-content-center">
                            <h3 className="deep-grey-text mt-3 mb-4 pb-1 mx-5">ลงทะเบียนผู้ดูแลระบบ</h3>
                        </Form.Row>
                        <Form.Group >
                        ...
                        <Form.Row >
                            ...
                            <Form.Group as={Col} >
                                ...
                                <Form.Control type="number" name="personal_id" onChange={this.oninput} />
                            </Form.Group>
                        </Form.Row>
                        ...
                        <Form.Row>
                            ...
                            <Form.Group as={Col}  md='5'>
                                ...
                                />
                                {/* </div> */}
                                {/* <Form.Control type="text" placeholder="01/01/1001" name="dob" onChange={this.oninput} /> */}
                            </Form.Group>
                        </Form.Row>
